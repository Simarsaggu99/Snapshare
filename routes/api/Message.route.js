...
const archiveConversation = require("../../controllers/message/archiveConversation");
const unArchiveConversation = require("../../controllers/message/unArchiveConversation");
...
//remove archive
router.delete("/conversation/:id/unArchive", unArchiveConversation);
