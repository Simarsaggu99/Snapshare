...
const policy = () => {
  return (
    <div className="p-20 container mx-auto">
      <h1>Privacy Policy for Prime Time Trucking Show under Punjabi Trucking USA </h1>

      <p>At Prime Time Trucking Show, accessible from https://punjabitruckingusa.com/, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Prime Time Trucking Show and how we use it.</p>
      ...
      <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
        website with regards to the information that they shared and/or collect in Prime Time Trucking Show.
      ...
      <p>Prime Time Trucking Show follows a standard procedure of using log files. These files log visitors
      ...
      <p>Like any other website, Prime Time Trucking Show uses 'cookies'. These cookies are used to store
      ...
      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of
        Prime Time Trucking Show.</p>

      <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons
        that are used in their respective advertisements and links that appear on Prime Time Trucking Show,
      ...
      <p>Note that Prime Time Trucking Show has no access to or control over these cookies that are used by
        third-party advertisers.</p>

      <h2>Third Party Privacy Policies</h2>

      <p>Prime Time Trucking Show's Privacy Policy does not apply to other advertisers or websites. Thus, we
      ...
      <p>Prime Time Trucking Show does not knowingly collect any Personal Identifiable Information from
