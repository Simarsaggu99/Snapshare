...
const defaultMeta = {
  ...
  siteName: "Snapshare",
  description:
    "Are you looking for the best memes? You've made it to the right place. Search memes at Snapshare and have fun!",
...
export default function SearchPageSeo(props: SeoProps) {
  ...
  return (
    <Head>
      ...
      <meta
        property="og:title"
        content={`${props.searchInput} search memes on Snapshare`}
      />
